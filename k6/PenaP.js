...
export default function() {
	...
	group("page_1 - Aspen Enterprise Insights | Login", function() {
		...
		let sessionToken = jsonRes.SessionToken
		console.log(sessionToken)
		let guid = jsonRes.GUID
		let publicGuID = jsonRes.PublicGUID
		...
		"<?xml version='1.0' encoding='utf-8'?><soap:Envelope xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/'><soap:Body> <FlowGetDefaultPremiseServer xmlns='http://www.flowtools.co.uk/'><GUID><![CDATA["+guid+"]]></GUID><Token><![CDATA["+token+"]]></Token></FlowGetDefaultPremiseServer></soap:Body></soap:Envelope>",
			{
				"cookies": {
				"ASP.NET_SessionId": "jdufim5rlzkb5iwu1rxwrfte",
					"S_SESSION_TOKEN": ""+sessionToken+"",
					"AWGUID": ""+guid+"",
					"AWTOK": ""+token+"",
					"AWPUBLICIDENTIFIER": ""+publicGuID+"",
					"I": ""+publicGuID+"",
					"V": ""+token+""
			},
			"headers": {
		...
		"{\"SettingName\":\"WidgetCurrentPageID\",\"SettingValue\":\"1763114\",\"GUID\":\""+guid+"\",\"Token\":\""+token+"\"}",
			{
				"cookies": {
				"ASP.NET_SessionId": "jdufim5rlzkb5iwu1rxwrfte",
					"S_SESSION_TOKEN": ""+sessionToken+"",
		...
		"{\"PublicGuid\":\""+publicGuID+"\",\"Token\":\""+token+"\"}",
			{
				"cookies": {
				"ASP.NET_SessionId": "jdufim5rlzkb5iwu1rxwrfte",
					"S_SESSION_TOKEN": ""+sessionToken+"",
		...
		"{\"GUID\":\""+guid+"\",\"Token\":\""+token+"\",\"WidgetPageInstanceIDList\":\"14393382;14393383;\",\"ClientData\":{\"global\":[{\"Key\":\"global\",\"Values\":[]}],\"pages\":[{\"Key\":\"1763114\",\"Values\":[]}],\"widgets\":[{\"Key\":\"14393382\",\"Values\":[]},{\"Key\":\"14393383\",\"Values\":[]}]},\"PageID\":\"1763114\",\"IgnoreUserSpecific\":false}",
			{
				"cookies": {
				"ASP.NET_SessionId": "jdufim5rlzkb5iwu1rxwrfte",
					"S_SESSION_TOKEN": ""+sessionToken+"",
		...
		// Request #19
		res = http.get("https://push2.sabisu.co/SignalR/hubs/negotiate?clientProtocol=1.5&I="+publicGuID+"&V="+token+"&AppIdentifications=&connectionData=%5B%7B%22name%22%3A%22pushhub%22%7D%5D&_=1633112464197",
			{
				"headers": {
		...
		// Request #24
		res = http.post("https://"+__ENV.pena+"/SabisuPremise/api/Widget/WidgetGetWidgetContent",
		"{\"GUID\":\""+guid+"\",\"Token\":\""+token+"\",\"WidgetPageInstanceIDList\":\"14393382;\",\"ClientData\":{\"global\":[{\"Key\":\"global\",\"Values\":[]}],\"pages\":[{\"Key\":\"1763114\",\"Values\":[]}],\"widgets\":[{\"Key\":\"14393382\",\"Values\":[]}]},\"PageID\":\"1763114\",\"IgnoreUserSpecific\":false}",
			{
				"cookies": {
				"ASP.NET_SessionId": "jdufim5rlzkb5iwu1rxwrfte",
					"S_SESSION_TOKEN": ""+sessionToken+"",
		...
		// Request #25
		res = http.post("https://"+__ENV.pena+"/SabisuPremise/api/Widget/WidgetGetWidgetContent",
		"{\"GUID\":\""+guid+"\",\"Token\":\""+token+"\",\"WidgetPageInstanceIDList\":\"14393383;\",\"ClientData\":{\"global\":[{\"Key\":\"global\",\"Values\":[]}],\"pages\":[{\"Key\":\"1763114\",\"Values\":[]}],\"widgets\":[{\"Key\":\"14393383\",\"Values\":[]}]},\"PageID\":\"1763114\",\"IgnoreUserSpecific\":false}",
			{
				"cookies": {
				"ASP.NET_SessionId": "jdufim5rlzkb5iwu1rxwrfte",
					"S_SESSION_TOKEN": ""+sessionToken+"",
		...
		"{\"ErrorText\":\"WS: /SabisuPremise/Default.aspx: \",\"Args\":\"{\\\"GUID\\\":\\\""+guid+"\\\",\\\"Token\\\":\\\""+token+"\\\"}\",\"GUID\":\"UNABLE_TO_RETRIEVE_GUID\",\"Token\":\"UNABLE_TO_RETRIEVE_TOKEN\"}",
			{
				"cookies": {
				"ASP.NET_SessionId": "jdufim5rlzkb5iwu1rxwrfte",
					"S_SESSION_TOKEN": "",
